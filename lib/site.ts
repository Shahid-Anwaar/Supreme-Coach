export const siteConfig = {
    ...
    keywords: [
        "coaching business infrastructure",
        "coaching website design service",
        "custom coaching platform",
        "done-for-you coaching website",
        "coaching CRM setup",
        "coaching business setup service"
    ],
    author: "Shahid Anwaar",
    creator: "Shahid Anwaar",
    publisher: "Supreme Coach",
